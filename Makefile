...
TARGET = sample_event_handler sample_sigslot sample_timer sample_once_event sample_fd_event sample_signal_event sample_toggle_event
HEADERS = libevent.h

all: $(TARGET)

$(TARGET): sample_event_handler.cpp sample_sigslot.cpp sample_timer.cpp sample_once_event.cpp sample_fd_event.cpp sample_signal_event.cpp sample_toggle_event.cpp $(HEADERS)
