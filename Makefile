...
$(TARGET): sample_event_handler.cpp sample_sigslot.cpp sample_timer.cpp sample_once_event.cpp sample_fd_event.cpp sample_signal_event.cpp sample_toggle_event.cpp sample_fs_event.cpp $(HEADERS)
