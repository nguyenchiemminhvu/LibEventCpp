...
TARGET = sample_event sample_sigslot sample_timer sample_once_event
HEADERS = libevent.h

all: $(TARGET)

$(TARGET): sample_event.cpp sample_sigslot.cpp sample_timer.cpp sample_once_event.cpp $(HEADERS)
